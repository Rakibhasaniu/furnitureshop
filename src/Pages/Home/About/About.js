        ...
        <div className="row">
          <div className="col-lg-5 d-flex justify-content-center align-items-center">
            <div className="aboutImg">
              <img
                className="image"
                src="https://i.ibb.co/WvP9mgP/MG-7858.jpg"
                alt=""
              />
            </div>
          </div>
          <div className="col-lg-7 d-flex justify-content-center align-items-center">
            <div className="Mdabout">
              ...
              <h6 className="Small_Text pb-1 fs-5">Md.Rakib Hasan</h6>
              <p>
                Hi, As you already know my name is Rakib.I am a student of the
                Islamic Unuversity,Kushtia depertment of Computer Science And
                Engineering.
                <br />
                <br />
